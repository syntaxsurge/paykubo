...
export function GET() {
  return NextResponse.json({
    ...
    info: {
      ...
      version: '1.0.0',
      description:
        'USDC-native paid API marketplace and x402 gateway for the configured EVM network.'
    },
    servers: [
      {
    ...
    components: {
      securitySchemes: {
        x402Payment: {
          ...
          name: 'X-PAYMENT',
          description:
            'Signed x402 payment payload generated by an x402 buyer client for USDC settlement on the configured EVM network.'
        },
        managedCreditApiKey: {
          type: 'http',
          scheme: 'bearer',
