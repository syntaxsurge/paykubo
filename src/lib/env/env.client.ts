...
const clientSchema = z.object({
  ...
  NEXT_PUBLIC_MORPH_HOODI_CHAIN_ID: optionalNumber,
  NEXT_PUBLIC_MORPH_HOODI_RPC_URL: optionalUrl,
  NEXT_PUBLIC_MORPH_HOODI_EXPLORER_URL: optionalUrl,
  NEXT_PUBLIC_X402_NETWORK: optionalString,
  NEXT_PUBLIC_USDC_TOKEN_ADDRESS: optionalString,
  NEXT_PUBLIC_USDC_TOKEN_NAME: optionalString,
  NEXT_PUBLIC_USDC_TOKEN_VERSION: optionalString,
  NEXT_PUBLIC_USDC_TOKEN_DECIMALS: optionalNumber,
...
export const envClient = clientSchema.parse({
  ...
  NEXT_PUBLIC_MORPH_HOODI_CHAIN_ID:
    process.env.NEXT_PUBLIC_MORPH_HOODI_CHAIN_ID,
  NEXT_PUBLIC_MORPH_HOODI_RPC_URL: process.env.NEXT_PUBLIC_MORPH_HOODI_RPC_URL,
  NEXT_PUBLIC_MORPH_HOODI_EXPLORER_URL:
    process.env.NEXT_PUBLIC_MORPH_HOODI_EXPLORER_URL,
  ...
  NEXT_PUBLIC_USDC_TOKEN_NAME: process.env.NEXT_PUBLIC_USDC_TOKEN_NAME,
  NEXT_PUBLIC_USDC_TOKEN_VERSION: process.env.NEXT_PUBLIC_USDC_TOKEN_VERSION,
  NEXT_PUBLIC_USDC_TOKEN_DECIMALS: process.env.NEXT_PUBLIC_USDC_TOKEN_DECIMALS,
